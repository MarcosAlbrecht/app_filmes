...
class MovieDetailsGenreResponse {
  ...
  factory MovieDetailsGenreResponse.fromJson(Map<String, dynamic> json) => _$MovieDetailsGenreResponseFromJson(json);
...
class MovieDetailsBackdropResponse {
  ...
  factory MovieDetailsBackdropResponse.fromJson(Map<String, dynamic> json) => _$MovieDetailsBackdropResponseFromJson(json);
