  ...
  Widget build(BuildContext context) {
      ...
      (_, next) {
        next.whenOrNull(
          error: (error, stackTrace) {
            showErrorSnackBar('Não foi possível adicionar seu filme aos favoritos');
          },
        );
      },
    );
    ref.listen(
      ...
      (_, next) {
        next.whenOrNull(
          error: (error, stackTrace) {
            showErrorSnackBar('Não foi possível remover seu filme dos favoritos');
          },
        );
      },
    );
    return InkWell(
      onTap: () {
        Navigator.of(context).pushNamed('/movie_detail', arguments: widget.id);
      },
      child: Stack(
        children: [
          SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(fontSize: 11, fontWeight: FontWeight.w400, color: AppColors.lightGrey),
                ),
              ],
            ),
          ),
